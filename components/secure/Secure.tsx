  ...
  return (
    <div className="my-10 lg:my-20 flex flex-col justify-center items-center w-full">
      ...
      <h3 className="mt-4 lg:mt-8 mb-10 md:mb-12 text-center w-11/12 lg:w-2/3 mx-auto uppercase text-xs sm:px-0 md:text-sm tracking-[4px] text-secondary">
        Our medical device platform and development processes are certified
        compliant with the following healthcare industry standards and
        regulatory frameworks
      </h3>
      <div className="flex flex-wrap gap-5 lg:gap-12 ">
        <Image src={img1} alt="ISO 13485" width={60} height={60}></Image>
        <Image src={img2} alt="FDA 21 CFR Part 820" width={60} height={60}></Image>
        <Image src={img3} alt="HIPAA Compliant" width={60} height={60}></Image>
      </div>
    </div>
  );
};
